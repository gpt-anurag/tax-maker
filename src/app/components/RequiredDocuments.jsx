...
const RequiredDocuments = () => {
  return (
    <div className="flex flex-col gap-8 p-4 lg:max-w-2xl">
      <div className="grid grid-cols-2 gap-4 rounded-md border-2 bg-teal-100 p-4">
        {documents_data
      ...
      <div className="grid grid-cols-2 gap-4 rounded-md border-2 bg-cyan-100 p-4">
        {documents_data
      ...
      <div className="grid grid-cols-2 gap-4 rounded-md border-2 bg-sky-100 p-4">
        {documents_data
