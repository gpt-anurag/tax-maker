      ...
      <SectionContainer>
        <div className='flex justify-between items-center gap-10 py-10'>
          ...
          <div className='basis-7/12 w-full'>
            <img
              src='https://images.unsplash.com/photo-1682686581660-3693f0c588d2?ixlib=rb-4.0.3&ixid=M3wxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2071&q=80'
              alt='accent image'
